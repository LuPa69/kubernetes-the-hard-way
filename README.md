...
This tutorial walks you through setting up Kubernetes the hard way. This guide is not for people looking for a fully automated command to bring up a Kubernetes cluster. If that's you then check out [Oracle Cloud Infrastructure Container Engine for Kubernetes (OKE)](https://www.oracle.com/es/cloud/cloud-native/container-engine-kubernetes/), or the [Getting Started Guides](https://kubernetes.io/docs/setup).
